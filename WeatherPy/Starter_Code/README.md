...
* In this assignment, we were tasked with using Python requests, APIs, and JSON traversals to answer the question: "What is the weather like as we approach the equator?" Included is my python code, analysis, cvs file, and images of the graphs I created. <br>
* I utilized previous class activites in order to write my code. <br>

# Instructions<br>
This activity is broken down into two deliverables, WeatherPy and VacationPy.<br>
